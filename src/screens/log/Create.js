  ...
  const genMnemonic = newMnemonic => {
    while (true) {
      ...
      const duplicates = words.filter(
        (word, index) => index !== words.indexOf(word),
      );
          ...
          <View style={[styles.inputBox]}>
            ...
            <TouchableOpacity onPress={() => cleaerPress()}>
              <Image
                ...
                source={
                  iconDic[
                    'Clear_icon_' + (focusedClear ? 'selected' : 'default')
                  ]
                }
              />
            </TouchableOpacity>
          ...
          <View style={[styles.inputBox]}>
            ...
            <TouchableOpacity onPress={() => setfocusedDark(!focusedDark)}>
              <Image
                style={styles.icon}
                source={
                  iconDic['Dark_icon_' + (focusedDark ? 'selected' : 'default')]
                }
              />
            </TouchableOpacity>
          </View>
          <View style={[styles.inputBox]}>
            ...
            <TouchableOpacity
              ...
              <Image
                ...
                source={
                  iconDic[
                    'Confirm_icon_' + (focusedConfirm ? 'selected' : 'default')
                  ]
                }
              />
            </TouchableOpacity>
